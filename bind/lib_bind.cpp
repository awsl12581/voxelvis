...
PYBIND11_MODULE(teavoxelui, m)
{
    ...
    pybind11::class_<vis::voxel::voxel_cofig>(m, "VoxelConfig")
        ...
        .def_property(
            "position",
            [](const vis::voxel::voxel_cofig& self) { return vec3_to_tuple(self.position); },
            [](vis::voxel::voxel_cofig& self, const std::tuple<float, float, float>& pos) {
        ...
        .def_property(
            "color",
            [](const vis::voxel::voxel_cofig& self) { return vec3_to_tuple(self.color); },
            [](vis::voxel::voxel_cofig& self, const std::tuple<float, float, float>& col) {
