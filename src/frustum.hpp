    ...
    namespace helper
    {
        ...
        public:
            ...
            void update(const glm::mat4 &viewProjMatrix)
            {
                ...
                // 从视图投影矩阵中提取六个平面
                planes.emplace_back(glm::vec3(viewProjMatrix[0][3] + viewProjMatrix[0][0],
                ...
                planes.emplace_back(glm::vec3(viewProjMatrix[0][3] + viewProjMatrix[0][1],
                ...
                planes.emplace_back(glm::vec3(viewProjMatrix[0][3] + viewProjMatrix[0][2],
            ...
            bool isCubeInFrustum(const glm::vec3 &position, float size) const
            {
                for (const auto &plane : planes)
                {
                    ...
                    if (!plane.isInFront(position + halfSize) &&
                        !plane.isInFront(position - halfSize))
                        return false;
                }
                return true;
            }
